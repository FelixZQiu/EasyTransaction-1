...
public class DataBaseTransactionLogConfiguration {
	...
	public DataBaseTransactionLogCleanJob logCleanJob(EasyTransMasterSelector master, DataBaseTransactionLogWritterImpl logWritter, DatabaseTransactionLogProperties properties) {
	...
	/**
	 * to avoid multiple database bean register in beanfactory user should create this bean
	 * @author deyou
	 */
